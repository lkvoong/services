...
import org.collectionspace.services.PropagationJAXBSchema;
...
/**
 * PropagationSortByTest, tests sorting of summary lists by fields
 * of various datatypes.
 *
 * $LastChangedRevision: 2562 $
 * $LastChangedDate: 2010-06-22 23:26:51 -0700 (Tue, 22 Jun 2010) $
 */
public class PropagationSortByTest extends BaseServiceTest {

    private final String CLASS_NAME = PropagationSortByTest.class.getName();
    ...
    private final String SERVICE_PATH_COMPONENT = "propagations";
...
*/
    ...
    public void cleanUp() {
        ...
        // Delete all Propagation resource(s) created during this test.
    ...
    private PropagationsCommon read(String csid) throws Exception {
