...
-- CRH 2/2/2013
-- Must CREATE the following first:
--   CREATE TYPE voucherlabeltype
--   CREATE FUNCTION public.findhybridaffinhtml(tigid character varying)
/*
...
-- GRANT EXECUTE ON FUNCTION public.findvoucherlabels() to PUBLIC;
