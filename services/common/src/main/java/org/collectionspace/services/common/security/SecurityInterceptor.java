...
@ServerInterceptor
@Provider
public class SecurityInterceptor implements PreProcessInterceptor, PostProcessInterceptor { // README - https://howtodoinjava.com/resteasy/resteasy-containerrequestfilter-example/
